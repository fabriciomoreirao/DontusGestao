...
export default function DiaryModule({ module, busy, operate }: { module: DiaryModuleData; busy: boolean; operate: Operate }) {
  ...
  return <>
    <header className="page-header diary-header module-page-header"><div className="module-page-title"><span className="module-page-title-icon"><ClipboardList size={21} /></span><span className="module-page-copy"><span className="eyebrow">MÓDULO · ROTINA DIÁRIA</span><h1>Diário de Bordo</h1><p>Suas atividades manuais e compromissos da agenda sob sua responsabilidade, em um único lugar.</p></span></div><div className="module-page-actions"><button className="primary-button" onClick={() => setCreating(true)}><Plus size={17} /> Nova atividade</button></div></header>
